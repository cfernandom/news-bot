...
class MedicalTopicClassifier:
    ...
    def __init__(self):
        self.topic_keywords = {
            MedicalTopic.TREATMENT: {
                "high": ["chemotherapy", "immunotherapy", "targeted therapy", "treatment", "therapy", "medication", "drug therapy"],
                "medium": ["treatment plan", "clinical trial", "protocol", "regimen", "combination therapy"],
                "low": ["medicine", "pharmaceutical", "therapeutic"]
            },
            MedicalTopic.DIAGNOSIS: {
                "high": ["diagnosis", "diagnostic", "biopsy", "pathology", "staging", "grade"],
            ...
            MedicalTopic.RESEARCH: {
                "high": ["research", "study", "clinical trial", "breakthrough", "discovery"],
                "medium": ["scientists", "researchers", "investigation", "findings"],
                "low": ["data", "analysis", "results"]
            },
            MedicalTopic.SURGERY: {
                "high": ["surgery", "surgical", "mastectomy", "lumpectomy", "reconstruction"],
            ...
            MedicalTopic.GENETICS: {
                "high": ["genetic", "brca", "hereditary", "mutation", "genetic testing"],
            ...
            MedicalTopic.SUPPORT: {
                "high": ["support group", "counseling", "psychological support", "patient support"],
    ...
    def classify_article(self, title: str, summary: str, content: str = "") -> TopicResult:
        """
    ...
    def get_topic_distribution(self, articles_data: List[Dict]) -> Dict[MedicalTopic, int]:
        """
