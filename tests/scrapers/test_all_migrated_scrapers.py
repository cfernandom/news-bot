...
class BreastCancerOrgTest(ScraperTestFramework):
    ...
    async def test_scraper_specific(self):
        ...
        try:
            ...
            print(
                f"   ✅ URL pattern: {url_check['count']} articles match breastcancer.org pattern"
            )
    ...
    async def test_scraper_specific(self):
        ...
        try:
            ...
            date_quality_query = """
                ...
                WHERE source_id = $1
            """
            date_check = await db_manager.execute_sql_one(
                date_quality_query, self.source_id
            )
            ...
            print(
                f"   ✅ Date parsing: {date_check['recent_dates']}/{date_check['total']} articles have valid recent dates"
            )
    ...
    async def test_scraper_specific(self):
        ...
        try:
            ...
            content_quality_query = """
                ...
                WHERE source_id = $1
            """
            content_check = await db_manager.execute_sql_one(
                content_quality_query, self.source_id
            )
            ...
            print(
                f"   ✅ Summary quality: {content_check['with_quality_summary']}/{content_check['total']} articles have quality summaries"
            )
    ...
    async def test_scraper_specific(self):
        ...
        try:
            ...
            consistency_query = """
                ...
                WHERE source_id = $1
            """
            consistency_check = await db_manager.execute_sql_one(
                consistency_query, self.source_id
            )
            ...
            print(
                f"   ✅ Metadata consistency: Country {consistency_check['correct_country']}/{consistency_check['total']}, Language {consistency_check['correct_language']}/{consistency_check['total']}"
            )
...
async def run_comprehensive_test_suite():
    ...
    test_classes = [BreastCancerOrgTest, WebMDTest, CureTodayTest, NewsMedicalTest]
